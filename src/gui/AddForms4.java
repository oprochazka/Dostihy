...
public class AddForms4 extends JDialog{
	...
	public AddForms4(final JFrame parentFrame, final EditDatabase database) throws EmployeeDBException, SQLException {
		super(parentFrame);
		setTitle("Add Horse");
		...
		JLabel lbPlace = new JLabel("porok ");
		...
		btnOk.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {				
				...
				try {
					aHorse = database.getPrint4(myDate, myDate2);
				} catch (SQLException | EmployeeDBException e3) {
					// TODO Auto-generated catch block
					e3.printStackTrace();
				}
				
				String[] namesColl = {"Kůň", "Počet dostihů"};
